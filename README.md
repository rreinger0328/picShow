...
- 原图和视频下载使用后端附件响应，并带签名下载链接，移动端下载器不带登录 cookie 时也能保存文件。
- HEIC/HEIF 原图下载会按设备自适应：Android 下载 JPG，iPhone/iPad 下载 HEIC 原文件。
...
应用会把这些文件识别为实况图片。HEIC/HEIF 原图会在服务端转成 WebP 预览用于网页展示；下载时 Android 会得到 JPG，iPhone/iPad 会得到 HEIC 原文件。
